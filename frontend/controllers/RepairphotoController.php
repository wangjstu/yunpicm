...
use frontend\models\Repairphoto;
use yii\web\UploadedFile;
use yii\filters\VerbFilter;
use yii\filters\AccessControl;
use yii\web\HttpException;
/**
 * Class RepairphotoController
 * @package frontend\controllers
 * 修片师相关操作页面
 */
class RepairphotoController extends \yii\web\Controller
{
    /**
     * @inheritdoc
     */
    ...
    public function actionCreate($id)
    {
        ...
        if (empty($model->Repairpictures)) {
            if (Yii::$app->request->isPost) {
                $postdata = Yii::$app->request->post();
                $postdata['Repairpictures'] = array();
    ...
    public function actionUpdate($id)
    {
        ...
        if (Yii::$app->request->isPost) {
            $postdata = Yii::$app->request->post();
            $postdata['Repairpictures'] = $model->Repairpictures;
        ...
        if (!empty($postdata)) {
            ...
            if (!empty($picfile)) {
                ...
                foreach ($picfile as $k=>$fileeach) {
                    $saveFileDir = Yii::$app->PictureTool->generateFileSaveDir('repair'.Yii::$app->user->id);
